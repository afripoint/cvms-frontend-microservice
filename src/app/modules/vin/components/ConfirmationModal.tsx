  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 animate-fadeIn">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6 animate-slideIn">
        ...
        <div className="mb-6">
          <p className="mb-3">Are you sure you want to add this VIN to your cart?</p>
        ...
        <div className="flex space-x-3 justify-end">
          ...
          <button
            onClick={onConfirm}
            className="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-black rounded-md transition"
          >
            Yes, Add to Cart
          </button>
        </div>
